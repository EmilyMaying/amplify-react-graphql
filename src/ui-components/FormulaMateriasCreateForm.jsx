...
import { createFormulaMaterias } from "../graphql/mutations";
export default function FormulaMateriasCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createFormulaMaterias.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FormulaMateriasCreateForm")}
      {...rest}
    >
      <TextField
        label="Quantidade"
